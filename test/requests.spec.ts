...
describe('requests', () => {
  ...
  test('请求错误', done => {
    ...
    function next(reason: AxiosResponse | AxiosError) {
      ...
      expect(reason as AxiosError).toBeTruthy()
  ...
  test('post 请求返回json数据 正确返回', done => {
  ...
  test('post 请求返回json数据 错误返回', done => {
    let response: AxiosResponse
  ...
  test('FormData', () => {
    ...
    getAjaxRequest().then(request => {
      expect(request.requestHeaders.contentType).toBe('multipart/form-data')
    })
  })
})
